    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center text-white">
        ...
        <p className="mb-8 text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto">
          We're building the computer vision base model for action sports.
        </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto" role="form" aria-label="Email waitlist signup">
          ...
          <Button type="submit" size="lg" className="whitespace-nowrap" disabled={isSubmitting} aria-describedby="hero-submit-desc">
            {isSubmitting ? 'Submitting...' : submitStatus === 'success' ? '✓ Joined!' : 'Join the Waitlist'}
          </Button>

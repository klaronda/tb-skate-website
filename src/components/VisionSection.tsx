    ...
    <section className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1745443257521-562bc3513e56?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxza2F0ZWJvYXJkJTIwaGFsZnBpcGUlMjBhZXJpYWx8ZW58MXx8fHwxNzU4OTIyOTU4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
            alt="Skateboard halfpipe aerial"
